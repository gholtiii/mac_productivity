...
az deployment sub create --name ${VM_NAME} --template-file ./vm.bicep --location eastus2 --parameters vmName="${VM_NAME}" subnetID=${SUBNET_ID} sku="rhel-lvm79-gen2" linux=true
