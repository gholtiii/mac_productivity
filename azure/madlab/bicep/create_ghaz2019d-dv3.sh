...
az deployment sub create --name ghaz2019d-dv3 --template-file ./vm.bicep --location eastus2 --parameters vmName=${VM_NAME} subnetID=${SUBNET_ID} sku=2019-Datacenter
