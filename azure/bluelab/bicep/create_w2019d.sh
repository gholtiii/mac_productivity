...
# Where are we getting the subscription from, e.g. image.gallery.live.eastus2 is accessible from bluelab
...
az deployment sub create --name ghaz2019d-dv1 --template-file ./vm.bicep --location eastus2 --parameters vmName=${VM_NAME} subnetID=${SUBNET_ID} sku=2019-Datacenter
